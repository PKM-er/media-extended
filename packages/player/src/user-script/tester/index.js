...
// derive from https://github.com/violentmonkey/violentmonkey/blob/2dc17ffee8f29cdf51f4da2efc15ebe47194b0c8/src/background/utils/tester.js
...
export function testScript(url, script) {
  ...
  const excMat = mergeLists(
    custom.origExcludeMatch && meta.excludeMatch,
    custom.excludeMatch,
  );
