# Media Extended Plugin Commands for Obsidian
...
- **Set playback speed**: Adjust the playback speed to a specific rate.
- **Reset playback speed**: Reset the playback speed to the default rate.
- **Increase playback speed**: Increase the playback speed within a range of predefined increments (`0.25x`, `0.5x`, `1x`, `1.5x`, `2x`, `3x`, `5x`, `10x`).
